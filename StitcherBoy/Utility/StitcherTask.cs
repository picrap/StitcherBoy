namespace StitcherBoy.Utility
{
    ...
    public abstract class StitcherTask<TActualProgram> : Task
        where TActualProgram : StitcherTask<TActualProgram>, new()
    {
        /// <summary>
        /// Gets the logging.
        /// </summary>
        ...
        /// Call this method from console application Main() method.
        /// </summary>
        /// <param name="args">The arguments.</param>
        protected static int Run(string[] args)
        {
            return Run(new TActualProgram(), args) ? 0 : 1;
        }

        private static bool Run(StitcherTask<TActualProgram> instance, string[] args)
        {
